...
section .data
	...
	msg1 db "7240: Pranavi Kundu", 10, "Write X86/64 ALP to accept five 64-bit hexadecimal numbers from user and store them in an array, then display the accepted numbers.", 10, "Date: 22 January 2025", 10
